...
//搜尋條件
	if($sNM != ""){
		$PageCond .= "&sNM=" . $sNM;
		$myWhere .= " and TemplateName like '%" . $sNM . "%' ";
	}
//主檔	: 最新消息
	$Sql = " 
		Select
...
<title>擴思訊 Cross Think 後台 課表範本管理</title>
...
<?php include_once(root_path . "/SystemMaintain/CommonPage/header_system_helper.php");?>                
    ...
    <div class="doc">
        ...
        <div class="mainOptionTool">
            <ul>
                <li class="title"><span class="sized-text-normal">課表名稱</span> <input type="text" id="sNM" name="sNM" class="search sized-text-normal"></li>
                <li class="find"><button type="button"><span id="TxtTipBtnSrh" class="sized-text-normal">搜尋</span></button></li>
                <li class="new"><button type="button" onClick="Excute('Add');"><span class="sized-text-normal">新增課表</span></button></li>
            </ul>
            <div class="clearFloat"></div>
        </div>
        <!-- 資料管理操作 end -->
        ...
        <div class="dataIndexList themeSet1">
            ...
            <form name="DataForm" id="DataForm" method="post">
            	...
            	<tr>
                	<th>&nbsp;</th>
                    <th class="topHeader"><span class="hor-box-text-large">課表名稱</span></th>
                    <th class="topHeader"><span class="hor-box-text-large">建立人員</span></th>
                ...
                <tr <?php if($lineCount % 2 == 1){ echo ' class="odd"';}else{ echo ' class="even"' ;}?>>
                    ...
                    <td><span class="hor-box-text-normal"><?php echo DspDate(substr($initAry[8],0,8),"/").' '. DspTime(substr($initAry[8],8,6),":")?></span></td>
                </tr>
                <?php }?>
                <!--<tr class="even">
                	<th valign="middle">
