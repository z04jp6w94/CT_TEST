        <div class="addSystemUser newClass">
            <table cellpadding="0" cellspacing="0" class="leftHeader">
                <tr>
                    ...
                    <td valign="middle"><span class="hor-box-text-normal">105 擴思訊之福祿貝爾1-10 20天班</span></td>
                </tr>
                <tr>
                    <th valign="top"><span class="hor-box-text-normal">班級級別：</span></th>
                    <td valign="middle">
                    	<select class="halfWidth sized-text-1" disabled>
                        	<option>大班</option>
                            <option>中班</option>
                            <option>小班</option>
                        </select>
                ...
                <tr>
                    ...
                    <td valign="middle">
                    	<select class="halfWidth sized-text-1" disabled>
                        	<option>105 擴思訊之福祿貝爾1-10 20天班</option>
                            <option>105 擴思訊之福祿貝爾1-10 20天班</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="middle"><span class="hor-box-text-normal">每週一次</span></td>
                </tr>
                <tr>
                    <th valign="top"><span class="hor-box-text-normal">排課開始時間：</span></th>
                    <td valign="middle"><input type="text" class="halfWidth sized-text-normal" value="2016/01/01" disabled></td>
                </tr>
                <tr>
                    <th valign="top"><span class="hor-box-text-normal">上課日期：</span></th>
                    <td valign="middle">
                    	<label><input type="checkbox" checked disabled><span class="sized-text-1">週一</span></label>&nbsp;
                        <label><input type="checkbox" disabled><span class="sized-text-1">週二</span></label>&nbsp;
                        <label><input type="checkbox" disabled><span class="sized-text-1">週三</span></label>&nbsp;
                        <label><input type="checkbox" disabled><span class="sized-text-1">週四</span></label>&nbsp;
                        <label><input type="checkbox" disabled><span class="sized-text-1">週五</span></label>&nbsp;
                        <label><input type="checkbox" disabled><span class="sized-text-1">週六</span></label>&nbsp;
                        <label><input type="checkbox" disabled><span class="sized-text-1">週日</span></label>
                    </td>
                </tr>
                <tr>
