			...
			$.post(
				...
				function(xml){
					...
					if($('resu', xml).text() == '1'){
						...
						window.location.replace("H_1.html");
					}else{
						alert($('rtmsg', xml).text());
					}
				}
...
<body>
    <div class="cover">
        ...
        <form name="DataForm" id="DataForm" method="post" action="H_0(login_Action).php">
        ...
        <button type="button" class="findPwd"><span>忘記密碼</span></button>
    </div>
</body>
</html>
