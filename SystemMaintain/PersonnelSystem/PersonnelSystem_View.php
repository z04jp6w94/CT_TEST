        ...
        <div class="addSystemUser">
        	<table cellpadding="0" cellspacing="0" class="leftHeader">
                <tr>
                    ...
                    <td valign="middle"><input type="text" class="halfWidth sized-text-normal" placeholder="必填" readonly value="<?php echo $rs["FullName"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class=needMark "hor-box-text-normal">帳號＊：</span></th>
                    <td valign="middle"><input type="text" class="halfWidth sized-text-normal" placeholder="Email" readonly value="<?php echo $rs["Account"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="needMark hor-box-text-normal">密碼＊：</span></th>
                    <td valign="middle"><input type="password" class="halfWidth sized-text-normal" placeholder="必填" readonly value="<?php echo $rs["PWD"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">連絡電話1：</span></th>
                    <td valign="middle"><input type="text" class="halfWidth sized-text-normal" placeholder="必填" readonly value="<?php echo $rs["Tel1"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">連絡電話2：</span></th>
                    <td valign="middle"><input type="text" class="halfWidth sized-text-normal" placeholder="必填" readonly value="<?php echo $rs["Tel2"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">角色：</span></th>
                    <td valign="middle">
                    	<select id="RoleId" name="RoleId" disabled class="halfWidth sized-text-1">
