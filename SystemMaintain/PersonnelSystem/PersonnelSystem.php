...
//主檔	: 最新消息
	$Sql = " 
		Select
			Id, FullName, Account, CreateDate, LastEditorId, LastEditDate, Enabled
		From Personnel
	";
	$Sql .= $myWhere;
	$Sql .= " and DeleteStatus = 'N'";
	$Sql .= " and IdentityTypeId in ('000000000000000')";
	$Sql .= "
		order by Id desc
	";
//	echo $Sql;	
    ...
    <div class="doc">
        ...
        <div class="mainOptionTool">
            <ul>
                ...
                <li class="help"><sub>搜尋條件包含：姓名、主帳號 EMAIL</sub></li>
                <li class="new"><button type="button" onClick="Excute('Add');"><span class="sized-text-normal">新增使用者</span></button>　<button type="button" onClick="Excute('Role');"><span class="sized-text-normal">角色權限</span></button></li>
            </ul>
            <div class="clearFloat"></div>
        </div>
        <!-- 資料管理操作 end -->
        ...
        <div class="dataIndexList themeSet1">
            ...
            <form name="DataForm" id="DataForm" method="post">
            	...
            	<tr>
                	<th>&nbsp;</th>
                    <th class="topHeader"><span class="hor-box-text-large">姓名</span></th>
                    <th class="topHeader"><span class="hor-box-text-large">帳號</span></th>
                    <th class="topHeader"><span class="hor-box-text-large">角色</span></th>
                    <th class="topHeader"><span class="hor-box-text-large">建立時間</span></th>
                    <th class="topHeader"><span class="hor-box-text-large">最後修改時間</span></th>
                    <th class="topHeader"><span class="hor-box-text-large">最後修改人</span></th>
                </tr>
                <?php
					$lineCount = 0;
                ...
                <tr <?php if($lineCount % 2 == 1){ echo ' class="odd"';}else{ echo ' class="even"' ;}?>>
                    ...
                    <td><span class="hor-box-text-normal">最大管理者</span></td>
                    <td class="leftAlignText"><span class="hor-box-text-normal"><?php echo DspDate(substr($initAry[3],0,8),"/").' '. DspTime(substr($initAry[3],8,6),":")?></span></td>
                ...
                <!--<tr class="even">
                    ...
                    <td><span class="hor-box-text-normal">業務</span></td>
                    <td class="leftAlignText"><span class="hor-box-text-normal">2015/01/01 14:00</span></td>
                    <td class="leftAlignText"><span class="hor-box-text-normal">2015/01/01 14:00</span></td>
                    <td><span class="hor-box-text-normal">DEREK WU</span></td>
                </tr>-->
            </table>
        </div>
        <!-- 資料檢視表格 end -->
