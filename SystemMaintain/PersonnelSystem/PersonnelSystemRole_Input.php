...
//關閉資料庫連線
	$MySql -> db_close();
    $_SESSION["RoleTreeStatus"] = "Add";							                                    //權限樹狀態
?>
<!DOCTYPE HTML>
<!--[if lt IE 9]>
...
<script type="text/javascript">
    ...
    function ChkForm(_Form) {
        ...
        SetKey(arrRoleGroup.join(","));

        DataForm.action = 'PersonnelSystemRole_AddNew.php';
        DataForm.submit();
        /*
        ...
        <div class="definitionSystemUser">
        	<div class="memberControl">
        		<ul>
                    ...
                    <li class="type">
                    	<input type="text" id="RoleName" name="RoleName" class="halfWidth sized-text-normal" placeholder="必填" value="">
                    </li>
                </ul>
                <div class="clearFloat"></div>
            </div>
