...
<body><div class="cover">
        ...
        <form name="DataForm" id="DataForm" method="post" action="MemberLoginAction.php">
			...
			<div id="Sign" class="signAlert" style="display:none"><p>請洽擴思訊管理人員</p></div>
        </form>
        <button type="button" class="login mainLogin" onClick="ChkForm()"><span>登入</span></button>
        <button type="button" onClick="ShowSign('Sign');" class="findPwd smallSize"><span>忘記密碼</span></button>
