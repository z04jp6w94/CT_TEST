	...
	<script type="text/javascript">
		...
		*/
		...
		function ChkForm(){
			...
			$("input").removeAttr("disabled");							//避免表單錯誤
...
<?php include_once(root_path . "/SystemMaintain/CommonPage/header_topmenu_item_5.php");?>        
        ...
        <div class="breadCrumb">
            <ul>
                ...
                <li class="current"><span class="hor-box-text">檢視使用者</span></li><!-- 如果沒有，就不寫入這個LI -->
        ...
        <div class="addSystemUser">
            ...
            <form name="DataForm" id="DataForm" method="post" action="<?php echo $gMainFile?>_Update.php" autocomplete="off">
                ...
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="K" name="K" readonly class="halfWidth sized-text-normal" placeholder="必填" value="<?php echo $rs["KindergartenName"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="needMark hor-box-text-normal">帳號＊：</span></th>
                    <td valign="middle"><input type="text" id="Account" name="Account" readonly class="halfWidth sized-text-normal" placeholder="必填" value="<?php echo $rs["Account"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="needMark hor-box-text-normal">密碼＊：</span></th>
                    <td valign="middle"><input type="password" id="PWD" name="PWD" readonly class="halfWidth sized-text-normal" placeholder="必填" value="<?php echo $rs["PWD"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="needMark hor-box-text-normal">Email＊：</span></th>
                    <td valign="middle"><input type="text" id="Email" name="Email" readonly class="halfWidth sized-text-normal" placeholder="必填" value="<?php echo $rs["Email"];?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="middle">
                    	<label><input type="radio" id="IsECE" name="IsECE" disabled value="N" <?php if($rs["IsECE"]=='N'){ echo 'selected';?><?php }?>><span class="sized-text-1">無</span></label>&nbsp;
                    	<label><input type="radio" id="IsECE" name="IsECE" disabled value="Y" <?php if($rs["IsECE"]=='Y'){ echo 'selected';?><?php }?>><span class="sized-text-1">有</span></label>
                    	<input type="text" id="KindergartenName" name="KindergartenName" readonly class="smallWidth sized-text-normal" placeholder="必填" value="<?php echo $rs["KindergartenName"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="needMark hor-box-text-normal">教具（無／有）＊：</span></th>
                    <td valign="middle">
                    	<label><input type="radio" id="HaveAid" name="HaveAid" disabled value="N" <?php if($rs["HaveAid"]=='N'){ echo 'checked';?><?php }?>><span class="sized-text-1">無</span></label>&nbsp;
                    	<label><input type="radio" id="HaveAid" name="HaveAid" disabled value="Y" <?php if($rs["HaveAid"]=='Y'){ echo 'checked';?><?php }?>><span class="sized-text-1">有</span></label>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="middle">
                    	<input type="text" id="" name="" readonly class="miniWidth sized-text-normal" placeholder="必填" value="">&nbsp;<span class="sized-text-1">套</span>
                        
                        <div class="spacingBlock"></div>
                        
                        <span class="sized-text-1">教具來源：</span>&nbsp;
                        <label><input type="checkbox" id="TeachingAidSource" name="TeachingAidSource" disabled value="1" <?php if($rs["TeachingAidSource"]== '1'){ echo 'checked';?><?php }?>><span class="sized-text-1">自購</span></label>&nbsp;
                        <label><input type="checkbox" id="TeachingAidSource" name="TeachingAidSource" disabled value="2" <?php if($rs["TeachingAidSource"]== '2'){ echo 'checked';?><?php }?>><span class="sized-text-1">他人送</span></label>&nbsp;
                        <label><input type="checkbox" id="TeachingAidSource" name="TeachingAidSource" disabled value="3" <?php if($rs["TeachingAidSource"]== '3'){ echo 'checked';?><?php }?>><span class="sized-text-1">其他</span></label>&nbsp;<input type="text" id="TeachingAidSource" name="TeachingAidSource" readonly class="miniWidth sized-text-normal" placeholder="必填" value="">
                ...
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="Contact" name="Contact" readonly class="halfWidth sized-text-normal" value="<?php echo $rs["Contact"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">聯絡電話：</span></th>
                    <td valign="middle"><input type="text" id="Tel1" name="Tel1" readonly class="halfWidth sized-text-normal" value="<?php echo $rs["Tel1"];?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="WechatId" name="WechatId" readonly class="halfWidth sized-text-normal" value="<?php echo $rs["WechatId"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">聯絡人 Email：</span></th>
                    <td valign="middle"><input type="text" id="ContactPersonEmail" name="ContactPersonEmail" readonly class="halfWidth sized-text-normal" value="<?php echo $rs["ContactPersonEmail"];?>"></td>
                </tr>
                <tr>
            ...
            <form name="DataForm2" id="DataForm2" method="post" action="<?php echo $gMainFile?>_Update.php" autocomplete="off">
                ...
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="FullName" name="FullName" readonly class="halfWidth sized-text-normal" placeholder="必填" value="<?php echo $rs["FullName"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="needMark hor-box-text-normal">帳號＊：</span></th>
                    <td valign="middle"><input type="text" id="Account" name="Account" readonly class="halfWidth sized-text-normal" placeholder="必填" value="<?php echo $rs["Account"];?>"></td>
            ...
            <div class="authInfo" id="ctx_basicAuth">
                <table cellpadding="0" cellspacing="0" class="leftHeader">
                    <tr>
                        ...
                        <td valign="middle">
                        	<input type="text" id="TeacherNum" name="TeacherNum" readonly class="halfWidth sized-text-normal" value="<?php echo $rs2["TeacherNumber"];?>">
						</td>
                    </tr>
                    <tr>
                        <th valign="top"><span class="needMark hor-box-text-normal">寶貝帳號數＊：</span></th>
                        <td valign="middle">
                        	<input type="text" id="StudentNum" name="StudentNum" readonly class="halfWidth sized-text-normal" value="<?php echo $rs2["StudentNumber"];?>">
						</td>
                    </tr>
                    <tr>
