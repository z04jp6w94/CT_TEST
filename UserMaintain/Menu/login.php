			...
			$.post(
				...
				function(xml){
					...
					if($('resu', xml).text() == '1'){
						...
						window.location.replace("MenuWelcome.php");
					}else{
						alert($('rtmsg', xml).text());
					}
				}
...
<body>
    <div class="cover">
    	<div class="logo"><img src="../images/login_logo_web.jpg"></div>
		...
		<div id="Sign" class="signAlert" style="display:none"><p>請洽園方人員</p></div>
        </form>
        <button type="button" class="login" onClick="ChkForm()"><span>登入</span></button>
        <button type="button" onClick="ShowSign('Sign');" class="findPwd"><span>忘記密碼</span></button>
    </div>
</body>
</html>
