...
<title>Web_園方 教師 自購家長(管理者介面) 班級與學生管理 學生管理 編輯學生</title>
...
<?php include_once(root_path . "/SystemMaintain/CommonPage/header_topmenu_item_4.php");?>          
        ...
        <div class="breadCrumb">
            <ul>
                ...
                <li class="current"><span class="hor-box-text">編輯學生</span></li><!-- 如果沒有，就不寫入這個LI -->
...
<form name="DataForm" id="DataForm" method="post" action="<?php echo $gMainFile?>_Update.php" autocomplete="off">
    ...
    <input id="now_count" name="now_count" type="hidden" value="<?php echo count($ParentAry);?>">
        <div class="addSystemUser newStudent">
            ...
            <table cellpadding="0" cellspacing="0" class="leftHeader">
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="Name" name="Name" class="halfWidth sized-text-normal" value="<?php echo $rs["Name"];?>"></td>
                    ...
                    <!--<td valign="top" rowspan="5"><div class="profilePhoto"><a href="javascript:;" onclick="alert('模擬：啟動檔案上傳對話框');" title="上傳圖片"><img src="../images/dog4.jpg"></a></div></td>-->
                ...
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="NickName" name="NickName" class="halfWidth sized-text-normal" value="<?php echo $rs["NickName"];?>"></td>
                    <th valign="top"><span class="hor-box-text-normal">身高（cm）：</span></th>
                    <td valign="middle"><input type="text" id="Height" name="Height" class="halfWidth sized-text-normal" value="<?php echo $rs["Height"];?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="Age_Y" name="Age_Y" class="miniWidth sized-text-normal" readonly value="<?php echo $rs["Age_Y"];?>"><span class="sized-text-normal">歲</span><input type="text" id="Age_M" name="Age_M" readonly class="miniWidth sized-text-normal" value="<?php echo $rs["Age_M"];?>"><span class="sized-text-normal">個月</span></td>
                    <th valign="top"><span class="hor-box-text-normal">頭圍（cm）：</span></th>
                    <td valign="middle"><input type="text" id="HeadCircumference" name="HeadCircumference" class="halfWidth sized-text-normal" value="<?php echo $rs["HeadCircumference"];?>"></td>
                </tr>
                <tr>
            ...
            <div class="increasableData">
                ...
                <table cellpadding="0" cellspacing="0" class="leftHeader">
                	<tr>
                        ...
                        <td valign="middle"><input type="text" id="Name<?php echo $i+1?>" name="Name<?php echo $i+1?>" class="fullWidth sized-text-normal" value="<?php echo $ParentAry[$i][2];?>"></td>
                        <th valign="top"><span class="hor-box-text-normal">身分描述：</span></th>
                        <td valign="middle">
                        	<select id="KinshipId<?php echo $i+1?>" name="KinshipId<?php echo $i+1?>" class="fullWidth sized-text-1">
                    ...
                    <tr>
                        ...
                        <td valign="middle"><input type="text" id="Tel1<?php echo $i+1?>" name="Tel1<?php echo $i+1?>" class="fullWidth sized-text-normal" value="<?php echo $ParentAry[$i][3];?>v"></td>
                        <th valign="top"><span class="hor-box-text-normal">聯絡電話2：</span></th>
                        <td valign="middle"><input type="text" id="Tel2<?php echo $i+1?>" name="Tel2<?php echo $i+1?>" class="fullWidth sized-text-normal" value="<?php echo $ParentAry[$i][4];?>"></td>
                    </tr>
                    <tr>
                    	<th valign="top"><span class="needMark hor-box-text-normal">行動電話1＊：</span></th>
                        <td valign="middle"><input type="text" id="Mobile1<?php echo $i+1?>" name="Mobile1<?php echo $i+1?>" class="fullWidth sized-text-normal" value="<?php echo $ParentAry[$i][5];?>"></td>
                        <th valign="top"><span class="hor-box-text-normal">行動電話2：</span></th>
                        <td valign="middle"><input type="text" id="Mobile2<?php echo $i+1?>" name="Mobile2<?php echo $i+1?>" class="fullWidth sized-text-normal" value="<?php echo $ParentAry[$i][6];?>"></td>
                    </tr>
                    <tr>
                    	<td colspan="4">
                        	<label><input type="checkbox" id="IsCarer<?php echo $i+1?>" name="IsCarer<?php echo $i+1?>" value="Y" <?php if($ParentAry[$i][8]=='Y'){?>checked<?php }?>><span class="sized-text-1">主要照顧者</span></label>&nbsp;
                            <label><input type="checkbox" id="IsEmergency<?php echo $i+1?>" name="IsEmergency<?php echo $i+1?>" value="Y" <?php if($ParentAry[$i][9]=='Y'){?>checked<?php }?>><span class="sized-text-1">緊急聯絡人</span></label>
                        </td>
                    </tr>
				</table> 	
                <?php }?>
            ...
            <table cellpadding="0" cellspacing="0" class="leftHeader">
            	<tr>
                    ...
                    <td valign="middle">
                    	<input type="text" id="MailingAddress" name="MailingAddress" class="fullWidth sized-text-normal" value="<?php echo $rs["MailingAddress"];?>"></td>
                </tr>
                <tr>
                    ...
                    <td valign="middle">
                        ...
                        <input type="text" id="ResidenceAddress" name="ResidenceAddress" class="fullWidth sized-text-normal lock" value="<?php echo $rs["ResidenceAddress"];?>">
					</td>
                </tr>
			</table>
            ...
            <table cellpadding="0" cellspacing="0" class="leftHeader">
                <tr>
                    ...
                    <td valign="middle">
						<?php for($i=0;$i<count($OptionAry);$i++){?>
                        	<label><input type="checkbox" id="Vaccination" name="Vaccination" value="<?php echo $OptionAry[$i][0];?>" <?php if(in_array( $OptionAry[$i][0], $VaAry, true)){?>checked<?php }?>><span class="sized-text-1"><?php echo $OptionAry[$i][4];?></span></label>&nbsp;
                            <?php if($i%5==0 && $i!=0){?>
                            	<br>
                            <?php }?>
                        <?php }?>
                ...
                <tr>
                    ...
                    <td valign="middle">
                    	<?php for($i=0;$i<count($MedAry);$i++){?>
                        	<label><input type="checkbox" id="OnceIllness" name="OnceIllness" value="<?php echo $MedAry[$i][0];?>" <?php if(in_array( $MedAry[$i][0], $OnAry, true)){?>checked<?php }?>><span class="sized-text-1"><?php echo $MedAry[$i][4];?></span></label>&nbsp;
                        <?php }?>
                    </td>
				</tr>
                <tr>
                    ...
                    <td valign="middle">
                    	<?php for($i=0;$i<count($OftenAry);$i++){?>
                        	<label><input type="checkbox" id="OftenIllness" name="OftenIllness" value="<?php echo $OftenAry[$i][0];?>" <?php if(in_array( $OftenAry[$i][0], $OfAry, true)){?>checked<?php }?>><span class="sized-text-1"><?php echo $OftenAry[$i][4];?></span></label>&nbsp;
                        <?php }?>
                    </td>
				</tr>
                <tr>
                    ...
                    <td valign="middle">
                    	<?php for($i=0;$i<count($FamAry);$i++){?>
                        	<label><input type="checkbox" id="FamilyHistory" name="FamilyHistory" value="<?php echo $FamAry[$i][0];?>" <?php if(in_array( $FamAry[$i][0], $FaAry, true)){?>checked<?php }?>><span class="sized-text-1"><?php echo $FamAry[$i][4];?></span></label>&nbsp;
                            <?php if($i%5==0 && $i!=0){?>
                            	<br>
                            <?php }?>
                        <?php }?>
                ...
                <tr>
                    ...
                    <td valign="middle">
                        ...
                        <label><input type="checkbox" id="DrugallergyStatus" name="DrugallergyStatus" value="3" <?php if($rs["DrugallergyStatus"] =='3'){?>checked<?php }?>><span class="sized-text-1">有</span></label>&nbsp;
                ...
                <tr>
                    ...
                    <td valign="middle">
						<textarea id="Remark" name="Remark" class="fullWidth hor-box-text-normal"><?php echo $rs["Remark"];?></textarea>
                    </td>
				</tr>
			</table>
</form>            
