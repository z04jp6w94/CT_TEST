...
<title>擴思訊 Cross Think 後台 教案管理 編輯教師</title>
...
<?php include_once(root_path . "/SystemMaintain/CommonPage/header_topmenu_item_4.php");?>          
        ...
        <div class="breadCrumb">
            <ul>
                ...
                <li class="current"><span class="hor-box-text">編輯教師</span></li><!-- 如果沒有，就不寫入這個LI -->
        ...
        <div class="addNewTeacher">
        	...
        	<table cellpadding="0" cellspacing="0" class="leftHeader">
                ...
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="Age" name="Age" class="halfWidth sized-text-normal" value="<?php echo $rs["Age"];?>"></td>
                </tr>
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="BirthPlace" name="BirthPlace" class="halfWidth sized-text-normal" value="<?php echo $rs["BirthPlace"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">現居地址：</span></th>
                    <td valign="middle"><input type="text" id="LivingAddress" name="LivingAddress" class="halfWidth sized-text-normal" value="<?php echo $rs["LivingAddress"];?>"></td>
                ...
                <tr>
                    ...
                    <td valign="middle"><input type="text" id="EmergencyContact" name="EmergencyContact" class="halfWidth sized-text-normal" value="<?php echo $rs["EmergencyContact"];?>"></td>
                    <th valign="top"><span class="hor-box-text-normal">子女：</span></th>
                    <td valign="middle"><input type="text" id="Child" name="Child" class="smallWidth sized-text-normal" value="<?php echo $rs["Child"];?>">個</td>
                </tr>
                <tr>
                	<th valign="top"><span class="needMark hor-box-text-normal">緊急聯絡人電話＊：</span></th>
                    <td valign="middle"><input type="text" id="Tel" name="Tel" class="halfWidth sized-text-normal" value="<?php echo $rs["Tel"];?>"></td>
                    <th valign="top"><span class="hor-box-text-normal">家庭狀況（描述）：</span></th>
                    <td valign="middle"><input type="text" id="FamilyDescription" name="FamilyDescription" class="halfWidth sized-text-normal" value="<?php echo $rs["FamilyDescription"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="needMark hor-box-text-normal">帳號＊：</span></th>
                    <td valign="middle"><input type="text" id="Account" name="Account" class="halfWidth sized-text-normal" value="<?php echo $rs["Account"];?>"></td>
                    <th valign="top"><span class="hor-box-text-normal">畢業學校／系所：</span></th>
                    <td valign="middle"><input type="text" id="GraduatedSchool" name="GraduatedSchool" class="halfWidth sized-text-normal" value="<?php echo $rs["GraduatedSchool"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="needMark hor-box-text-normal">密碼＊：</span></th>
                    <td valign="middle"><input type="password" id="PWD" name="PWD" class="halfWidth sized-text-normal" value="<?php echo $rs["PWD"];?>"></td>
                    <th valign="top"><span class="hor-box-text-normal">畢業時間：</span></th>
                    <td valign="middle"><input type="text" id="GraduatedTime" name="GraduatedTime" class="halfWidth sized-text-normal" value="<?php echo $rs["GraduatedTime"];?>"></td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">可用系統功能：</span></th>
                    <td valign="middle"><label><input type="checkbox" id="UseApp" name="UseApp" value="1" <?php if(stristr($rs["UseApp"], "1")){?>checked<?php }?>><span class="sized-text-1">Web</span></label>&nbsp;&nbsp;<label><input type="checkbox" id="UseApp" name="UseApp" value="2" <?php if(stristr($rs["UseApp"], "2")){?>checked<?php }?>><span class="sized-text-1">APP</span></label></td>
                    <th valign="top"><span class="hor-box-text-normal">入行時間：</span></th>
                    <td valign="middle"><input type="text" id="EntryTime" name="EntryTime" class="halfWidth sized-text-normal" value="<?php echo $rs["EntryTime"];?>"></td>
                </tr>
                <tr>
                	<th valign="top">&nbsp;</th>
                    <td valign="middle">&nbsp;</td>
                    ...
                    <td valign="middle">
                    	...
                    	<input type="text" id="FoodTaboosNote" name="FoodTaboosNote" class="smallWidth sized-text-normal" value="<?php echo $rs["FoodTaboosNote"];?>"></td>
                </tr>
            </table>
            <table cellpadding="0" cellspacing="0" class="leftHeader">
            	<tr>
                    ...
                    <td valign="middle">
                    	<?php for($i=0;$i<count($MedAry);$i++){?>
                        	<label><input type="checkbox" id="OptionalID" name="OptionalID" value="<?php echo $MedAry[$i][0];?>" <?php if(in_array( $MedAry[$i][0], $DTAry, true)){?>checked<?php }?>><span class="sized-text-1"><?php echo $MedAry[$i][4];?></span></label>&nbsp;
                            <?php if($i%6==0 && $i!=0){?>
                            	<div class="spacingBlock"></div>
                            <?php }?>
                        <?php }?>
                ...
                <tr>
                    ...
                    <td valign="middle">
                    	<label><input type="checkbox" id="DrugallergyStatus" name="DrugallergyStatus" value="1" <?php if($rs["DrugallergyStatus"]=='1'){?>checked<?php }?>><span class="sized-text-1">不清楚</span></label>&nbsp;
                    	<label><input type="checkbox" id="DrugallergyStatus" name="DrugallergyStatus" value="2" <?php if($rs["DrugallergyStatus"]=='2'){?>checked<?php }?>><span class="sized-text-1">無</span></label>&nbsp;
                        <label><input type="checkbox" id="DrugallergyStatus" name="DrugallergyStatus" value="3" <?php if($rs["DrugallergyStatus"]=='3'){?>checked<?php }?>><span class="sized-text-1">有</span></label>&nbsp;<input type="text" id="Drugallergy" name="Drugallergy" class="halfWidth sized-text-normal" value="<?php echo $rs["Drugallergy"];?>">
					</td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">抽菸：</span></th>
                    <td valign="middle">
                    	<label><input type="checkbox" id="Smoke" name="Smoke" value="N" <?php if($rs["Smoke"] =='N'){?>checked<?php }?>><span class="sized-text-1">無</span></label>&nbsp;
                    	<label><input type="checkbox" id="Smoke" name="Smoke" value="Y" <?php if($rs["Smoke"] =='Y'){?>checked<?php }?>><span class="sized-text-1">有，一天</span></label>&nbsp;<input type="text" id="SmokeUseNumber" name="SmokeUseNumber" class="miniWidth sized-text-normal" value="<?php echo $rs["SmokeUseNumber"];?>">根，&nbsp;
                        <span class="sized-text-1">菸齡</span></label>&nbsp;<input type="text" id="SmokeAge" name="SmokeAge" class="miniWidth sized-text-normal" value="<?php echo $rs["SmokeAge"];?>">年&nbsp;<label><input type="checkbox" id="Smoke" name="Smoke" value="O" <?php if($rs["Smoke"] =='O'){?>checked<?php }?>><span class="sized-text-1">
                        已戒</span></label>&nbsp;<input type="text" id="SmokeQuitAge" name="SmokeQuitAge" class="miniWidth sized-text-normal" value="<?php echo $rs["SmokeQuitAge"];?>">年
					</td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">檳榔：</span></th>
                    <td valign="middle">
                    	<label><input type="checkbox" id="Areca" name="Areca" value="N" <?php if($rs["Areca"] =='N'){?>checked<?php }?>><span class="sized-text-1">無</span></label>&nbsp;
                    	<label><input type="checkbox" id="Areca" name="Areca" value="Y" <?php if($rs["Areca"] =='Y'){?>checked<?php }?>><span class="sized-text-1">有，一天</span></label>&nbsp;<input type="text" id="ArecaUseNumber" name="ArecaUseNumber" class="miniWidth sized-text-normal" value="<?php echo $rs["ArecaUseNumber"];?>">顆，&nbsp;
                        <span class="sized-text-1">已嚼</span></label>&nbsp;<input type="text" id="ArecaAge" name="ArecaAge" class="miniWidth sized-text-normal" value="<?php echo $rs["ArecaAge"];?>">年&nbsp;<label><input type="checkbox" id="Areca" name="Areca" value="O" <?php if($rs["Areca"] =='O'){?>checked<?php }?>><span class="sized-text-1">
                        已戒</span></label>&nbsp;<input type="text" id="ArecaQuitAge" name="ArecaQuitAge" class="miniWidth sized-text-normal" value="<?php echo $rs["ArecaQuitAge"];?>">年
					</td>
                </tr>
                <tr>
                	<th valign="top"><span class="hor-box-text-normal">喝酒：</span></th>
                    <td valign="middle">
                    	<label><input type="checkbox" id="IsDrink" name="IsDrink" value="1" <?php if($rs["IsDrink"] =='1'){?>checked<?php }?>><span class="sized-text-1">無</span></label>&nbsp;
                    	<label><input type="checkbox" id="IsDrink" name="IsDrink" value="2" <?php if($rs["IsDrink"] =='2'){?>checked<?php }?>><span class="sized-text-1">偶而喝</span></label>&nbsp;
                        <label><input type="checkbox" id="IsDrink" name="IsDrink" value="3" <?php if($rs["IsDrink"] =='3'){?>checked<?php }?>><span class="sized-text-1">習慣性喝</span></label>&nbsp;
                        <label><input type="checkbox" id="IsDrink" name="IsDrink" value="4" <?php if($rs["IsDrink"] =='4'){?>checked<?php }?>><span class="sized-text-1">已戒酒</span></label>&nbsp;
                        <label><input type="checkbox" id="IsDrink" name="IsDrink" value="5" <?php if($rs["IsDrink"] =='5'){?>checked<?php }?>><span class="sized-text-1">不清楚</span></label>&nbsp;
					</td>
                </tr>
            </table>
</form>           
