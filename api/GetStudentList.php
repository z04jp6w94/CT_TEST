...
//Get班級 -> 學生(時間判斷
	$todayCode  = date('w', strtotime($WebDate));
	if($todayCode == '0'){
		$todayCode = '7';
	}
	...
	$Sql .= " and ".$WebDate." >= StartTime";
	$Sql .= " and ".$WebDate." <= REPLACE((select ClassTime from ClassTime C where 1 = 1 and C.ClassId = M.Id order by ClassTime desc limit 1),'-','') ";
